      ...
      <div class="row">
         <div class="row">
              ...
              <div class="form-group">
                  ...
                  <div class="radio" >
                  <label>
                         <input type="radio"  class="paymethod" name="paymethod" id="bank" value="transfer" checked="true" data-toggle="collapse"  data-parent="#accordion" data-target="#collapseOne" >Bank Transfer
                      </label> </div> 
              </div> 
                        <div class="panel"> 
                                <div class="panel-body">
                                    <div class="form-group ">
                                      <label>Keberangkatan Pembeli</label>
