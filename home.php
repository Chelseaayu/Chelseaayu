          ...
          <div id="slider-carousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
              <div class="item active">
                <div class="col-sm-6">
                  <!-- <h1><span>B</span>ERSUAKRIA</h1>
                  <h2>Nikmati indahnya alam Indonesia secara langsung dan Virtual</h2>
                  <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. </p>
                  -->
                </div>
                <!-- <div class="col-sm-6"> -->
                  <img src="images/shop/ra.png"class="girl img-responsive" alt="" />
              ...
              <div class="item">
                ...
                <!-- <div class="col-sm-6"> -->
                  <img src="images/shop/pr.png" class="girl img-responsive" alt="" />
                  <!-- <img src="images/home/pricing.png"  class="pricing" alt="" /> -->
                <!-- </div> -->
              </div>
              ...
              <div class="item">
                ...
                <!-- <div class="col-sm-6"> -->
                  <img src="images/shop/borobudur.png" class="girl img-responsive" alt="" />
                  <!-- <img src="images/home/pricing.png" class="pricing" alt="" /> -->
                <!-- </div> -->
      ...
      <div class="row">
        ...
        <div class="col-sm-9 padding-right">
          <div class="features_items"><!--features_items-->
            <h2 class="title text-center">  Features Item
       ...
       <?php  } ?>
          ...
          <div class="recommended_items"><!--recommended_items-->
            <h2 class="title text-center">Fatwa Kontol</h2>
